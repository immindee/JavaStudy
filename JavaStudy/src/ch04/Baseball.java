	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= 5; i++) {
			...
			if (inputNumber1 == baseball1) {
				strike = strike + 1;
			} else if (inputNumber1 == baseball2 || inputNumber1 == baseball3) { // 볼
				ball++;
			}
			if (inputNumber2 == baseball2) {
				strike = strike + 1;
			} else if (inputNumber2 == baseball1 || inputNumber2 == baseball3) { // 볼
				ball++;
			}
			if (inputNumber3 == baseball3) {
				strike = strike + 1;
			} else if (inputNumber3 == baseball2 || inputNumber3 == baseball1) { // 볼
				ball++;
			}
